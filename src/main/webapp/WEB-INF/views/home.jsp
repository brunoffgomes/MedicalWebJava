      ...
      <nav role="navigation" class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <ul ng-if="navCtrl.logged" class="nav navbar-nav navbar-right">
              <li><a href="#/miPerfil" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-user fa-fw"></i>Mi Perfil</a></li>
