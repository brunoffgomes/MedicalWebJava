...
public class EntidadMedicaFormDto {
	...
	private AdministradorFormDto administradorFormDto;
	
	public AdministradorFormDto getAdministradorFormDto() {
		return administradorFormDto;
	}
	public void setAdministradorFormDto(AdministradorFormDto administradorFormDto) {
		this.administradorFormDto = administradorFormDto;
	}
